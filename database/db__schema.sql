...
CREATE TABLE IF NOT EXISTS `tasti`.`reunion_publica-participantes` (
  ...
  `cui_participante` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `tasti`.`solicitud_revision-pregunta`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tasti`.`solicitud_revision-pregunta` ;

CREATE TABLE IF NOT EXISTS `tasti`.`solicitud_revision-pregunta` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `id_pregunta` INT(11) NOT NULL,
  `cui_usuario` INT(8) NOT NULL,
  `descripcion` LONGTEXT NOT NULL,
